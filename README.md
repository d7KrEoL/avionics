...
# [Скачать](https://github.com/d7KrEoL/avionics/releases/download/MAJOR/ViRPiL_Avionics_v0.1.3-beta.2209.tar)  
...
> [!WARNING]
> !Данный режим работает корректно только на сервере SAMP WARS, либо серверах, реализовавших радарный комплекс по тому же принципу, сохранив оригинальный текстдрав, из которого получается информация о цели!
